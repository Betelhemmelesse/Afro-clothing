...
function Mend5({ products, wishlist, onToggleWishlist, cart, onToggleCart }) {
  const braceletsProducts = products.filter(
    (product) => product.category === "mend5"
  );

  return (
    <div className="mend1-container">
      <div className="detail-description">
        <h1> CENTERAL Africa Men's fashion</h1>
      </div>
